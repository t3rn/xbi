...
pub fn setup() {
    ...
    simple_logger::SimpleLogger::new()
        ...
        .with_module_level("xcm", LevelFilter::Trace)
        .with_module_level("xcm::weight", LevelFilter::Trace)
        .with_module_level("xcm::buy_weight", LevelFilter::Trace)
        .with_module_level("xcm::execute", LevelFilter::Trace)
        .with_module_level("xcm::barriers", LevelFilter::Off)
